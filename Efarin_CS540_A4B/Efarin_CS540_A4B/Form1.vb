...
Public Class Form1
    ...
    Private Sub refreshLocalizableContent()
        ...
        IconicImage.Image = resx_cur.GetObject("greeting_picture")
    End Sub
    Private Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ExitButton.Click
        End
    End Sub
    ...
    Private Sub USAFlag_Click(ByVal sender As Object, ByVal e As EventArgs) Handles USAFlag.Click
        resx_cur = resx_usa
        refreshLocalizableContent()
    End Sub

    Private Sub AustriaFlag_Click(ByVal sender As Object, ByVal e As EventArgs) Handles AustriaFlag.Click
        resx_cur = resx_austria
        refreshLocalizableContent()
    End Sub

    Private Sub IconicImage_Click(sender As Object, e As EventArgs) Handles IconicImage.Click
